...
namespace Tmpl8
{
	...
	Asteroid newAsteroid2(1, 1, 0.4, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid3(2, 2, 0.4, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid4(0, 3, 0.3, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid5(1, 4, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid6(2, 5, 0.3, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid7(0, 6, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid8(1, 7, 0.3, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid9(0, 8, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid10(1, 9, 0.3, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid11(2, 10, 0.4, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid12(0, 11, 0.3, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid13(1, 12, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid14(2, 13, 0.3, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid15(0, 0, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid16(1, 1, 0.3, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid17(2, 2, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid18(0, 3, 0.3, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid19(1, 4, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid20(2, 5, 0.3, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid21(0, 6, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid22(1, 7, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid23(2, 8, 0.3, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid24(0, 9, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid25(1, 10, 0.3, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid26(2, 11, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	Asteroid newAsteroid27(0, 12, 0.3, player.m_position_x, player.m_position_y, 40, 40, 2);
	Asteroid newAsteroid28(1, 13, 0.4, player.m_position_x, player.m_position_y, 40, 40, 3);
	...
	{
		//char scoreToChar[(((sizeof player.m_score) * CHAR_BIT) + 2) / 3 + 2];

		char* scoreToChar = new char[10];

		itoa(player.m_score, scoreToChar, 10);

		screen->Print("Score: ", 700, 10, 0xffffff);
		screen->Print(scoreToChar, 750, 10, 0xffffff);
	}
	...
	void Game::CollisionCheck()
	{
		...
		if (enemyShip.CollisionDetection(playerBullet.m_bulletPosition_x, playerBullet.m_bulletPosition_y, 30, 30))
		{
			player.m_score += 200;
		}
		...
		for (unsigned int i = 0; i < sizeof(asteroidsInScene) / sizeof(asteroidsInScene[0]); i = i + 1)
		{
			...
			if (asteroidsInScene[i].CollisionDetection(playerBullet.m_bulletPosition_x, playerBullet.m_bulletPosition_y, 30, 30))
			{
	...
	void Game::Reset(Surface* screen) {}
};